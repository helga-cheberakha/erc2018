...
class MailchimpListsSubscription extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['allow_unsubscribed_member'] = array(
      '#title' => "Allow unsubscribed members",
      '#type' => "checkbox",
      '#description' => t('This will allow Mailchimp members to be unsubscribed instead of being deleted. If the "Mailchimp Subscription" field is unchecked the member will be unsubscribed. Note, checking this will add members to Mailchimp automatically.'),
      '#default_value' => $instance_settings['allow_unsubscribed_member'],
    );
