  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($roles as $id => $role) {
      $form['role']['alias'][$id]['allow'] = [
        ...
        '#default_value' => $role_alias[$id]['allow'] ?: 0,
      ];
      $form['role']['alias'][$id]['alias'] = [
        '#type' => 'textfield',
        '#default_value' => $role_alias[$id]['alias'] ?: $role->label(),
        '#size' => 50,
        '#maxlength' => 50,
      ];
      $form['role']['alias'][$id]['weight'] = [
        '#type' => 'weight',
        '#default_value' => $role_alias[$id]['weight'] ?: $role->getWeight(),
        '#delta' => 10,
        '#attributes' => ['class' => ['role-weight']],
      ];
      $form['role']['alias'][$id]['name'] = [
        '#type' => 'hidden',
        '#value' => $role_alias[$id]['name'] ?: $role->label(),
      ];
      $form['role']['alias'][$id]['#weight'] = $role_alias[$id]['weight'] ?: $role->getWeight();
